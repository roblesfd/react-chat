...
const filterUser = (users:UserProps[], userId: string) => (users.find((user) => user.id === userId));

export { pipeline, randomInt, pickRandom, shortenString, capitalizeString, getDecodedUser, filterUser };
